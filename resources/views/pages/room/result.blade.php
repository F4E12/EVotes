            ...
            <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-200 overflow-hidden px-4 sm:px-8">
                ...
                <div class="px-8 sm:px-12 py-8 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white">
                    <div>
                        ...
                        <p class="text-gray-500 mt-1">Real-time election analytics.</p>
                    </div>
                    ...
                    @if ($showResults && !$candidates->isEmpty())
                        <div class="flex items-center gap-3 bg-blue-50 px-5 py-3 rounded-2xl border border-blue-100">
                            ...
                            <div>
                                <span class="block text-xs font-bold text-blue-400 uppercase tracking-wider">Total Votes</span>
                ...
                <div class="p-8 sm:p-12">
                    ...
                    {{-- LOGIC: SHOW RESULTS OR HIDDEN STATE --}}
                    @if ($showResults)
                        ...
                        @if ($candidates->isEmpty())
                            <div class="text-center py-16 bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
                                ...
                                <p class="text-gray-500">There are no candidates listed in this room yet.</p>
                            </div>
                        @else
                                            ...
                                            @foreach ($candidates->sortByDesc('votes_count')->values() as $index => $candidate)
                                                ...
                                                <tr class="hover:bg-blue-50/20 transition-colors {{ $isWinner ? 'bg-yellow-50/30' : '' }}">
                                                    ...
                                                    <td class="px-8 py-6 whitespace-nowrap text-right">
                                                        ...
                                                        <span class="text-xs font-bold text-gray-400 block uppercase tracking-wide">Votes</span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                    ...
                    @else
                        ...
                        <div class="flex flex-col items-center justify-center py-20 text-center">
                            ...
                            <h3 class="text-2xl font-bold text-gray-900 mb-2">Results are Hidden</h3>
                            <p class="text-gray-500 max-w-md mx-auto mb-8 text-lg">The voting period is still active or the host has chosen to keep results private for now.</p>
                            ...
                            @if ($room->end_date)
                                <div class="inline-flex items-center gap-2 px-5 py-2.5 bg-yellow-50 text-yellow-800 rounded-xl border border-yellow-200 shadow-sm">
                                    ...
                                    <span class="font-bold text-sm">Results Revealed: {{ \Carbon\Carbon::parse($room->end_date)->format('d M Y, H:i') }}</span>
                                </div>
                            @endif
                        </div>
                    @endif
