        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($candidates as $candidate)
                    <div
                        class="bg-white overflow-hidden shadow-lg rounded-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300 flex flex-col">
                        ...
                        <div class="p-6 bg-gray-50 border-t border-gray-100 mt-auto">
                            <form action="{{ route('vote.store', $room->room_id) }}" method="POST">
                                ...
                                <input type="hidden" name="candidate_id"
                                    value="{{ $candidate->candidate_id ?? $candidate->id }}">
