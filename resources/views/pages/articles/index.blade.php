<x-app-layout>
    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-12">
            ...
            @php
                // Separate articles into "My Articles" and "Other Articles"
                $myArticles = $articles->where('author_id', auth()->id());
                $otherArticles = $articles->where('author_id', '!=', auth()->id());
            @endphp

            <!-- SECTION 1: MY ARTICLES (Table View) -->
            <div class="space-y-4">
                <h3 class="text-xl font-bold text-gray-900 pl-1 border-l-4 border-blue-600 leading-none">&nbsp;My Articles</h3>
                <div class = "h-8"></div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="5" class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center text-gray-500">
                                            You haven't written any articles yet. Click "Write Article" to start!
                                        </td>
                                    </tr>
                                    @endforelse
                                </tbody>
            ...
            <div class = "h-8"></div>
            <!-- SECTION 2: COMMUNITY NEWS (Card View) -->

            <div class="space-y-4">
                <h3 class="text-xl font-bold text-gray-900 pl-1 border-l-4 border-purple-600 leading-none">&nbsp;Community News</h3>
                 <div class = "h-4"></div>
                @if($otherArticles->isEmpty())
                    <div class="bg-white rounded-lg border border-gray-200 p-8 text-center text-gray-500">
                        No articles from other users yet.
                    </div>
                @else
