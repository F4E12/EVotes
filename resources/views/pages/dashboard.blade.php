    ...
    <div class="py-8 bg-gray-50">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-medium text-gray-900">Your Rooms</h3>
                ...
                @if ($rooms->isEmpty())
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border-2 border-dashed border-gray-300 p-8 text-center">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-1">No rooms created yet</h3>
                        <p class="text-sm text-gray-500 mb-6 max-w-sm mx-auto">Get started by creating your first voting room. It only takes a minute to set up.</p>
                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-300 flex flex-col h-full group">
                                ...
                                <div class="px-5 py-3 bg-gray-50 border-t border-gray-100 rounded-b-xl flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <span class="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Room Token:</span>
