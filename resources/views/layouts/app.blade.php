    ...
    <nav class="bg-white border-b border-gray-200 sticky top-0 z-50">
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden bg-white border-t border-gray-200">
            <div class="pt-2 pb-3 space-y-1">
                <a href="{{ route('dashboard') }}"
                    class="block pl-3 pr-4 py-2 border-l-4 {{ request()->routeIs('dashboard') ? 'border-blue-500 text-blue-700 bg-blue-50' : 'border-transparent text-gray-600 hover:bg-gray-50' }} text-base font-medium transition duration-150 ease-in-out">Dashboard</a>
                <a href="{{ route('join-a-room') }}"
                    class="block pl-3 pr-4 py-2 border-l-4 {{ request()->routeIs('join-a-room') ? 'border-blue-500 text-blue-700 bg-blue-50' : 'border-transparent text-gray-600 hover:bg-gray-50' }} text-base font-medium transition duration-150 ease-in-out">Join
                    Vote</a>
                <a href="{{ route('history') }}"
                    class="block pl-3 pr-4 py-2 border-l-4 {{ request()->routeIs('history') ? 'border-blue-500 text-blue-700 bg-blue-50' : 'border-transparent text-gray-600 hover:bg-gray-50' }} text-base font-medium transition duration-150 ease-in-out">History</a>
                <a href="{{ route('articles.index') }}"
                    class="block pl-3 pr-4 py-2 border-l-4 {{ request()->routeIs('articles.*') ? 'border-blue-500 text-blue-700 bg-blue-50' : 'border-transparent text-gray-600 hover:bg-gray-50' }} text-base font-medium transition duration-150 ease-in-out">Articles</a>
            </div>
